...
public class ORKConcussionWalkingStep : ORKActiveStep {
    ...
    var completionStep: ORKConcussionWalkingCompletionStep!
    
    //session containing step info
    var session: ORKConcussionWalkingSession!
    
    //initialization with ID and sequence
    init(identifier:String ,activity: ORKConcussionWalkingActivity, completionStep: ORKConcussionWalkingCompletionStep)
    {
